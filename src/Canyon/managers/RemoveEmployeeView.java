...
public class RemoveEmployeeView extends javax.swing.JFrame {
    ...
    public RemoveEmployeeView() {
        ...
        try {
            ...
            Logger.getLogger(RemoveEmployeeView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveEmployeeView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveEmployeeView().setVisible(true);
            }
        });
    }
